  ...
  if (!document.getElementById('trf-alert-modal')) {
    document.body.insertAdjacentHTML(
      ...
      '<div id="trf-alert-modal" class="trf-alert-modal is-hidden" aria-hidden="true">' +
        ...
        '<img src="clover_300.png" class="trf-alert-modal__icon" alt="" aria-hidden="true">' +
  ...
  if (!document.getElementById('trf-intro-screen')) {
    document.body.insertAdjacentHTML(
      ...
      '<div id="trf-intro-screen" class="trf-intro-screen is-hidden" aria-hidden="true">' +
        ...
        '<img src="clover_300.png" class="trf-intro-screen__logo" alt="Trifoglio clover logo">' +
...
infoButton.addEventListener('click', function (event) {
  ...
  const content =
    '<img src="clover_300.png" class="icon" alt="' +
    ...
    '</span>' +
    '<img src="assets/svelte-logo.svg" class="info-footer__logo" alt="' +
